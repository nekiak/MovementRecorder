...
public class MovementRecorderCommand implements ICommand {
  public static ArrayList<String> aliases =
      new ArrayList<>(Arrays.asList("movrec", "movementrecorder"));
  public static ArrayList<String> tabcompletion =
      new ArrayList<>(Arrays.asList("start", "stop", "play", "delete", "list"));
  ...
  public void processCommand(ICommandSender sender, String[] args) {
    ...
    LogUtils.sendError(
        "Invalid arguments. Usage: /movrec <start/play/delete/stop/list> <filename>");
  }
